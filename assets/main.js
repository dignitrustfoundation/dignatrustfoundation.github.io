...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.buttons-component.style-1', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.style-1', { style: 'zoom-out-image', speed: 750, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-8', { style: 'fade-in', speed: 2500, intensity: 5, threshold: 3, delay: 375, replay: false });
		onvisible.add('.container-component.instance-8 > .wrapper > .inner', { style: 'fade-in', speed: 125, intensity: 2, threshold: 1, delay: 0, replay: false });
		onvisible.add('.container-component.instance-10', { style: 'fade-in', speed: 2500, intensity: 5, threshold: 3, delay: 375, replay: false });
		onvisible.add('.container-component.instance-10 > .wrapper > .inner', { style: 'fade-up', speed: 750, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-7', { style: 'fade-down', speed: 2000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-2', { style: 'fade-left', speed: 1750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-2 > .wrapper > .inner', { style: 'fade-left', speed: 750, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.container-component.instance-5', { style: 'fade-in-background', speed: 1625, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-5 > .wrapper > .inner', { style: 'fade-left', speed: 750, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.container-component.instance-4', { style: 'fade-right', speed: 1750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-4 > .wrapper > .inner', { style: 'fade-right', speed: 750, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.container-component.instance-1', { style: 'fade-left', speed: 1750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-1 > .wrapper > .inner', { style: 'fade-left', speed: 750, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.container-component.instance-6', { style: 'fade-in', speed: 2500, intensity: 5, threshold: 3, delay: 375, replay: false });
		onvisible.add('.container-component.instance-6 > .wrapper > .inner', { style: 'fade-up', speed: 750, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-18 > .wrapper > .inner', { style: 'fade-right', speed: 750, intensity: 2, threshold: 3, delay: 125, replay: false });
